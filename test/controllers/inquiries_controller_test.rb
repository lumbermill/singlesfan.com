...
class InquiriesControllerTest < ActionController::TestCase
  ...
  test "should create inquiry" do
    assert_difference('Inquiry.count') do
      post :create, inquiry: { date: @inquiry.date, email: @inquiry.email, memo: @inquiry.memo, name: @inquiry.name }
    end
  ...
  test "should update inquiry" do
    patch :update, id: @inquiry, inquiry: { date: @inquiry.date, email: @inquiry.email, memo: @inquiry.memo, name: @inquiry.name }
    assert_redirected_to inquiry_path(assigns(:inquiry))
  end
