...
class MastersControllerTest < ActionController::TestCase
  ...
  test "should create master" do
    assert_difference('Master.count') do
      post :create, master: { active: @master.active, desc: @master.desc, email: @master.email, name: @master.name, password_digest: @master.password_digest, picture: @master.picture }
    end
  ...
  test "should update master" do
    patch :update, id: @master, master: { active: @master.active, desc: @master.desc, email: @master.email, name: @master.name, password_digest: @master.password_digest, picture: @master.picture }
    assert_redirected_to master_path(assigns(:master))
  end
